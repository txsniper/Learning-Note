...
class Solution(object):
    def __init__(self, data_path):
        ...
        self.train_csv = data_path + "/train/train.csv"
        self.test_csv = data_path + "/test/test.csv"
    ...
    def load_data(self):
        self.train_data = pd.read_csv(self.train_csv, nrows=100000)
...
def main():
    path = "D:\\BaiduYunDownload\\avazu-ctr-prediction"
